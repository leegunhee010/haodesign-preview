...
(function () {
  ...
  /* 서비스: 관리자 확정값으로 기본값 덮어쓰기 */
  var BAKED_SERVICE = {"ci":{"c":"CI·로고디자인","eng":"CI & LOGO","seo":{"h":"로고제작 · CI디자인","p1":"로고 디자인과 CI 디자인은 브랜드의 첫인상을 결정하는 가장 중요한 자산입니다. 로고 제작은 단순히 예쁜 심볼을 만드는 일이 아니라, 회사의 방향과 가치를 한 번에 전달하는 시각 언어를 설계하는 일입니다. 명함, 서식류, 홍보물, 간판까지 일관되게 적용되는 CI는 기업의 신뢰도를 높이고 브랜드 인지도를 만들어 갑니다.","p2":"로고 제작을 의뢰할 때는 회사 소개와 지향하는 방향, 선호하는 레퍼런스를 정리해 전달하면 시안의 정확도가 높아집니다. 완성된 로고는 AI 원본과 인쇄 · 온라인 겸용 파일로 제공받아야 명함 제작, 홍보물 제작에 바로 활용할 수 있습니다. 하오디자인은 로고 디자인부터 기본 응용 시스템, 사용 가이드까지 함께 정리해드립니다.","t1":"로고 및 CI에 대하여","t2":"로고 및 CI 준비 방법"},"desc":"브랜드의 방향을 담은 CI · 로고 — 명함부터 서식류까지 일관되게 확장합니다.","head":"로고는 회사의\n첫 문장입니다","label":"CI · 로고디자인","seoDesc":"회사 로고 제작과 CI 디자인. 명함·서식 등 기본 응용 시스템과 인쇄·온라인 겸용 파일까지 제공하는 하오디자인 브랜딩 서비스.","seoTitle":"로고 제작·CI 디자인 | 브랜드 로고·명함 디자인 | 하오디자인"},"photo":{"c":"촬영서비스","eng":"PHOTOGRAPHY","seo":{"h":"제품촬영 · 누끼촬영","p1":"제품 촬영은 카탈로그, 상세페이지, 홍보물의 품질을 좌우하는 출발점입니다. 누끼 촬영(배경 제거 컷)은 어디에나 활용하기 좋고, 연출 촬영은 제품의 분위기와 사용 장면을 전달합니다. 인쇄물에 들어갈 사진은 화면용과 달리 CMYK 색공간 기준의 보정이 필요해, 디자인을 아는 스튜디오에서 촬영하면 결과물의 완성도가 달라집니다.","p2":"제품 사진 촬영을 준비할 때는 촬영할 제품 실물과 참고 레퍼런스를 함께 전달하면 원하는 톤을 빠르게 맞출 수 있습니다. 필요한 컷 종류(누끼 · 연출 · 디테일)와 사용처(인쇄물 · 이커머스)를 미리 정하면 촬영 구성이 효율적입니다. 하오디자인은 촬영 → 보정 → 디자인 적용까지 한 팀으로 진행해 일정을 줄여드립니다.","t1":"제품 촬영에 대하여","t2":"제품 촬영 준비 방법"},"desc":"보정과 편집까지 한 팀에서 — 인쇄에 최적화된 제품 · 연출 컷을 만듭니다.","head":"디자인을 아는\n스튜디오의 촬영","label":"촬영서비스","seoDesc":"제품 누끼·연출 촬영과 인쇄 기준 보정. 디자인을 아는 스튜디오에서 촬영부터 보정·편집까지 한 팀으로 진행하는 하오디자인 제품촬영.","seoTitle":"제품 촬영·누끼 촬영 | 카탈로그·상세페이지 촬영 | 하오디자인"},"global":{"c":"다국어디자인","eng":"GLOBAL EDITION","seo":{"h":"다국어카탈로그 · 영문브로슈어제작","p1":"수출 기업에게 영문 카탈로그 제작, 중문 브로슈어 제작은 해외 바이어를 만나는 첫인상입니다. 다국어 디자인은 단순 번역이 아니라 언어별 글줄 길이와 타이포그래피 호흡에 맞춘 재조판 작업으로, 원본의 레이아웃과 브랜드 톤을 유지하는 것이 핵심입니다. 전시회 · 해외 영업용 다국어 홍보물은 수출바우처 등 정부지원사업과 연계해 제작 부담을 줄일 수도 있습니다.","p2":"다국어 카탈로그 제작을 준비할 때는 원본 디자인 파일과 언어별 번역문을 함께 준비하면 진행이 빠릅니다. 번역문이 없는 경우 번역 협업도 가능하며, 언어가 늘어도 일관된 톤을 유지하도록 같은 팀이 전체 언어를 관리하는 것이 좋습니다. 하오디자인은 영어 · 중국어 · 일본어 등 다국어 편집을 원본 제작과 함께 원스톱으로 진행합니다.","t1":"다국어 디자인에 대하여","t2":"다국어 디자인 준비 방법"},"desc":"영어 · 중국어 · 일본어 등 수출 시장의 언어까지 한 번에 담아냅니다.","head":"언어가 바뀌어도\n톤은 흔들리지 않게","label":"다국어디자인","seoDesc":"영문·중문·일문 다국어 카탈로그·브로슈어 제작. 원본 톤을 유지한 다국어 편집과 수출바우처 연계 제작까지 하오디자인이 지원합니다.","seoTitle":"다국어 카탈로그·영문 브로슈어 제작 | 수출 디자인 | 하오디자인"},"poster":{"c":"포스터·전단지","eng":"POSTER & FLYER","seo":{"h":"포스터제작 · 전단지제작","p1":"포스터 제작과 전단지 제작은 가장 직관적인 오프라인 홍보 수단입니다. 행사 포스터, 공연 포스터, 모집 공고 포스터는 멀리서도 읽히는 타이포그래피와 임팩트 있는 비주얼이 핵심이며, 판촉용 전단지는 짧은 시간에 혜택과 정보를 전달하는 구성이 중요합니다. 잘 만든 포스터 디자인 한 장은 지나가는 사람의 발걸음을 멈추게 합니다.","p2":"포스터 디자인을 준비할 때는 부착 장소와 보는 거리를 먼저 고려해 사이즈(A3~A0)와 글자 크기를 정해야 합니다. 전단지 제작은 배포 수량과 방식에 따라 용지와 인쇄 방식(디지털 · 옵셋)을 선택하면 비용을 효율적으로 줄일 수 있습니다. 하오디자인은 목적에 맞는 카피 위계 설계부터 인쇄 · 납품까지 한 번에 진행합니다.","t1":"포스터 및 전단지에 대하여","t2":"포스터 및 전단지 준비 방법"},"desc":"멀리서도 읽히는 위계와 임팩트 — 목적에 맞는 포스터 · 전단지를 만듭니다.","head":"지나가는 3초를\n붙잡는 한 장","label":"포스터 · 전단지","seoDesc":"행사·공연·모집 포스터, 판촉 전단지 제작. 멀리서도 읽히는 포스터 디자인부터 인쇄·납품까지 하오디자인이 한 번에 진행합니다.","seoTitle":"포스터 제작·전단지 디자인 | 행사·홍보 포스터 인쇄 | 하오디자인"},"catalog":{"c":"카탈로그·브로슈어","eng":"CATALOG & BROCHURE","seo":{"h":"카탈로그제작 · 브로슈어제작","p1":"기업의 이미지를 효과적으로 전달하는 가장 기본적인 홍보물이 바로 카탈로그와 브로슈어입니다. 카탈로그 제작은 제품과 서비스를 체계적으로 보여줄 수 있으며, 브로슈어 제작은 브랜드 스토리를 감각적으로 담아내는 데 적합합니다. 기획 단계에서부터 디자인, 인쇄, 후가공까지 전문적인 과정을 거쳐 완성되는 카탈로그 디자인과 브로슈어 디자인은 기업의 신뢰도를 높이고 차별화된 경쟁력을 제공합니다. 전시회, 영업 현장, 온라인 홍보까지 활용도가 높아 많은 기업이 카탈로그 · 브로슈어 제작을 통해 마케팅 성과를 경험하고 있습니다.","p2":"카탈로그 제작이나 브로슈어 디자인을 준비할 때는 먼저 목적과 타깃을 명확히 설정하고, 그에 맞는 구성과 페이지 수를 기획하는 것이 중요합니다. 디자인 단계에서는 브랜드 아이덴티티에 맞는 레이아웃과 색상을 적용하고, 인쇄 단계에서는 종이 재질과 후가공(코팅, 박, 제본 등)을 신중히 선택해야 완성도가 높아집니다. 하오디자인은 회사소개서, 제품 카탈로그, 기업 브로슈어까지 기획부터 납품까지 원스톱으로 진행합니다.","t1":"카탈로그 및 브로슈어에 대하여","t2":"카탈로그 및 브로슈어 준비 방법"},"desc":"정보 전달을 넘어 브랜드의 강점이\n자연스럽게 전해지는 카탈로그를 만듭니다.","head":"좋은 카탈로그는\n설명보다 설득에 가깝습니다","label":"카탈로그 · 브로슈어","seoDesc":"회사소개서·제품 카탈로그·브로슈어 편집디자인부터 인쇄·후가공까지 원스톱. 기획·디자인·제작을 한 팀이 책임지는 하오디자인 카탈로그 제작 서비스.","seoTitle":"카탈로그 제작·브로슈어 디자인 | 회사소개서 편집디자인 | 하오디자인"},"leaflet":{"c":"리플렛","eng":"PAMPHLET & LEAFLET","seo":{"h":"팜플렛제작 · 리플렛제작","p1":"행사 안내, 제품 소개, 매장 홍보에 가장 널리 쓰이는 인쇄물이 팜플렛과 리플렛입니다. 리플렛 제작은 2단 · 3단 접지로 작은 지면에 핵심 정보를 효율적으로 담을 수 있고, 팜플렛 디자인은 배포와 휴대가 쉬워 전시회 · 박람회 · 오프라인 마케팅에서 높은 효과를 냅니다. 접지 방식과 읽는 동선까지 계산된 리플렛 디자인은 같은 내용도 더 잘 전달되게 만듭니다.","p2":"팜플렛 제작을 준비할 때는 배포 장소와 대상, 전달할 핵심 메시지를 먼저 정해야 합니다. 접지 방식(2단 · 3단 · 대문접지)에 따라 정보의 순서가 달라지므로 구성 기획이 중요하고, 용지 평량과 코팅 여부에 따라 손에 닿는 인상이 달라집니다. 하오디자인은 소량 디지털 인쇄부터 대량 옵셋 인쇄까지 목적과 수량에 맞는 팜플렛 · 리플렛 제작을 제안해드립니다.","t1":"팜플렛 및 리플렛에 대하여","t2":"팜플렛 및 리플렛 준비 방법"},"desc":"펼치고 접는 흐름까지 계산한 리플렛 — 작은 지면에 핵심만 담습니다.","head":"접는 순간까지\n설계된 한 장","label":"팜플렛 · 리플렛","seoDesc":"행사·매장·제품 안내 팜플렛·리플렛 제작. 2단·3단·대문접지 등 목적에 맞는 리플렛 디자인과 인쇄를 하오디자인이 원스톱으로 제작합니다.","seoTitle":"팜플렛·리플렛 제작 | 2단·3단 접지 리플렛 디자인 | 하오디자인"},"package":{"c":"패키지·라벨","eng":"PACKAGE & LABEL","seo":{"h":"패키지디자인 · 라벨제작","p1":"패키지 디자인은 매대에서 제품이 스스로 말을 걸게 만드는 가장 강력한 마케팅 도구입니다. 단상자 제작, 라벨 디자인, 스티커 제작, 쇼핑백 제작까지 — 제품을 감싸는 모든 요소가 브랜드 경험의 일부가 됩니다. 재질과 후가공에 따라 같은 디자인도 전혀 다른 인상을 주기 때문에 구조 설계부터 신중하게 접근해야 합니다.","p2":"패키지 제작을 준비할 때는 제품 실물 또는 정확한 치수와 함께 식품 · 화장품 등 품목별 표시사항 문구를 먼저 정리해야 합니다. 칼선(목형) 설계가 필요한 단상자 제작은 샘플 확인 후 양산에 들어가는 것이 안전합니다. 하오디자인은 소량 디지털 패키지부터 대량 옵셋 양산까지 재질 샘플 기반으로 제안해드립니다.","t1":"패키지 및 라벨에 대하여","t2":"패키지 및 라벨 준비 방법"},"desc":"제품의 가치를 그대로 전하는 패키지 · 라벨 디자인.","head":"선반 위에서\n먼저 말을 거는 디자인","label":"패키지 · 라벨","seoDesc":"단상자·라벨·스티커·쇼핑백 등 패키지 디자인 제작. 구조 설계부터 재질·후가공, 소량 제작과 양산까지 하오디자인이 함께합니다.","seoTitle":"패키지 디자인·라벨 제작 | 단상자·스티커 디자인 | 하오디자인"}};
